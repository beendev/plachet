...
export default function Footer() {
  return (
    <footer className="mt-16 bg-gradient-to-b border-t from-white to-neutral-50 relative">
      ...
      <div
        aria-hidden
        className="absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-neutral-300/40 to-transparent"
      />
...
function LandmarkIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        d="M4 9h16M6 9v9m4-9v9m4-9v9m4-9v9M3 20h18"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
